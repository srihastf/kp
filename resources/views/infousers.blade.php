...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Informasi Pengelolaan Data Users
      </h1>
        ...
        <div class="col-md-7">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">
                Mengelola data users seperti <b>tambah</b> data users, 
                <b>ubah</b> data users, <b>lihat</b> data users dan 
                <b>hapus</b> data users.</h3>
            </div>
            <div class="box-body">
              <ol>
                <li>Tambah Users : </li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <ul>
                ...
                <li>Users mendapatkan akun untuk mengakses SIP3KTI</li>
              </ul>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
